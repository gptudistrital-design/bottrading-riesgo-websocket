...
- Calcula los ganadores de Binance Futures por `priceChangePercent` de 24h desde el cache alimentado por WebSocket.
- Usa WebSocket de Binance (`!ticker@arr`) para mantener precios, cambios 24h y volumen en tiempo real, sin polling REST en operación normal.
...
| `SCAN_INTERVAL_SECONDS` | `60` | Frecuencia con la que se recalcula la tabla de ganadores desde el cache WebSocket. |
